...
<body>
    <header class="overflow-hidden fixed top-0 left-0 right-0 z-50 transition-all duration-300  bg-gray-50 p-0">
        <div class="flex flex-col md:flex-row justify-between items-center space-x-4 space-y-0 bg-[#0c63c7]  border-none p-2">
            <div class="flex flex-col md:flex-row   md:space-x-4  border-none  md:space-y-0 space-y-1">
                ...
                <a href="#" class="flex items-center  space-x-1 border-none">
                    ...
                    <div>
                    <span class="text-white text-md">M-F: 10:30AM-5:30PM</span>
                    <span class="text-white text-md">&</span>
                    <span class="text-white text-md">S-S:11AM-4:30PM</span>
                    </div>
                </a>
            </div>
            ...
            <div class="grid grid-cols-1  md:grid-cols-3 lg:grid-cols-5 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <ul class="space-y-4 text-gray-300">
                        <li>Mon-Frd: 10:30AM - 5:30PM</li>
                        <li>Sat-Sun: 11AM - 4:30PM</li>
                    </ul>
                </div>
