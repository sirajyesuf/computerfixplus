...
<nav class="shadow-md relative z-50 bg-[#1676d0]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex-shrink-0 flex items-center">
                <a href="/">
                    <img src="{{ asset('images/computerfixplus.png') }}" alt="computerfixplus logo" width="90" height="90">
                </a>
            </div>
            <div class="hidden md:flex items-center space-x-4 text-white font-bold">
                ...
                <a href="/quote" class="bg-[#f69c32] text-white hover:bg-yellow hover:text-dark-blue px-4 py-2 rounded-md transition duration-300">
                    Get a Quote
                </a>
            </div>
    ...
    <div id="mobile-menu" class="hidden md:hidden fixed inset-0 bg-light-blue bg-opacity-95 z-40 flex items-center justify-center">
        <div class="text-center space-y-8">
            ...
            <a href="/quote" class="inline-block bg-secondary text-white hover:bg-yellow hover:text-dark-blue px-6 py-3 rounded-md transition duration-300">
                Get a Quote
            </a>
        </div>
    </div>
...
<div class="relative bg-white overflow-hidden">
            ...
            <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                <div class="sm:text-center lg:text-left">
                    ...
                    <p class="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        We provide top-notch computer repair services to keep your devices running smoothly. Our team of skilled
    ...
    <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 hidden lg:block">
        <img src="{{asset('images/computerfixplushero.png')}}"
